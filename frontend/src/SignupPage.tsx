...
export default function SignupPage({
  ...
  const { register, confirm, loginWithGoogle, error, clearError } = useAuth()
            ...
            {step === 'form' ? (
              <form onSubmit={handleSignup} className="flex flex-col gap-3">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="h-11 bg-indigo hover:bg-indigo-dark disabled:opacity-60 text-white font-semibold rounded-lg text-sm flex items-center justify-center gap-2 transition-colors cursor-pointer mt-1"
                >
                  {submitting ? (
              ...
              <form onSubmit={handleConfirm} className="flex flex-col gap-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    autoFocus
                    className="w-full h-12 px-4 border border-cream-border rounded-lg text-sm text-ink text-center tracking-[0.3em] font-mono placeholder-ink-muted outline-none focus:ring-2 focus:ring-indigo/20 focus:border-indigo transition-colors"
                  />
                </div>
                ...
                <button
                  ...
                  className="h-11 bg-indigo hover:bg-indigo-dark disabled:opacity-60 text-white font-semibold rounded-lg text-sm flex items-center justify-center gap-2 transition-colors cursor-pointer"
                >
                  {submitting ? (
                    <Loader2 className="w-4 h-4 animate-spin" />
                  ) : (
                    <>
                      Verify & continue <span>&rarr;</span>
                    </>
                  )}
                </button>
              </form>
            ...
            {step === 'form' && (
              <>
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-3 h-11 border border-cream-border rounded-lg text-sm font-medium text-ink hover:bg-cream-50 transition-colors cursor-pointer"
                >
                  <GoogleIcon />
