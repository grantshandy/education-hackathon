          ...
          <div className="w-full max-w-sm flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <button
                ...
                className="flex items-center justify-center gap-3 h-12 border border-cream-border rounded-lg text-sm font-medium text-ink hover:bg-cream-50 transition-colors cursor-pointer"
              >
                <GoogleIcon />
