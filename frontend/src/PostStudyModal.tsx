...
export default function PostStudyModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center font-instrument">
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-3xl shadow-[0_16px_32px_rgba(10,9,21,0.1)] w-full max-w-[500px] p-8 flex flex-col items-center gap-6">
        {/* Close */}
        <button
          onClick={onClose}
        ...
        <div className="text-center flex flex-col gap-1">
          ...
          <p className="text-ink-secondary text-sm">
            Great work, Steven! Here's what you accomplished.
          </p>
        </div>
        ...
        <div className="w-full bg-indigo-bg/60 rounded-2xl p-5 flex flex-col gap-3">
          ...
          <button
            ...
            className="self-end flex items-center gap-1.5 bg-indigo hover:bg-indigo-dark text-white text-sm font-semibold px-5 py-2 rounded-full transition-colors cursor-pointer"
          >
